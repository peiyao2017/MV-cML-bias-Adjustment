setwd("/panfs/jay/groups/20/panwei/wan01299/collider_bias/BMI/MV_Egger/new/no_pleiotropy/d=1/")
...
for(t in 1:length(rhos)){
  ...
  betaGX=effect[[2]]*c(rep(1,times=50),rep(0,times=50),rep(0,times=900))
  MAF=effect[[3]]
  betaXY=effect[[4]]
  SNP_effect=betaGY
  ...
  for(t1 in 1:20){
    output=foreach(jt=1:50,.combine = "rbind")%dopar%{
      ...
      inp=mr_mvinput(bx=betaGX_IV,bxse =sdbetaGX_IV,by=betaGYC_IV,byse =sdbetaGYC_IV)
      ...
      DD=indexevent(seed = 2018,lambda = seq(0.25, 5, 0.25),B = 10, method = c("Simex"),prune = NULL,xbeta=betaGX_IV, xse=sdbetaGX_IV,ybeta=betaGYC_IV,yse=sdbetaGYC_IV,weighted = T)
      ...
      result1=data.frame(rs=gwas_y$rs,beta_before=gwas_y$beta,se_before=gwas_y$s.d.,p_before=gwas_y$p,beta_after=betaGYadj,se_after1=sdbetaGYadj1,se_after2=sdbetaGYadj2,se_after3=sdbetaGYadj3,p_after1=pvalueadj1,p_after2=pvalueadj2,p_after3=pvalueadj3,beta_DD=betaGYadj_DD,se_DD1=SDbetaGYadj_DD1,se_DD2=SDbetaGYadj_DD2,p_DD1=pvalueadj_DD1,p_DD2=pvalueadj_DD2,beta_egger=betaGYadj_egger,se_egger1=SDbetaGYadj_egger1,se_egger2=SDbetaGYadj_egger2,p_egger1=pvalueadj_egger1,p_egger2=pvalueadj_egger2,beta_SH=betaGYadj_SH,se_SH1=SDbetaGYadj_SH1,se_SH2=SDbetaGYadj_SH2,p_SH1=pvalueadj_SH1,p_SH2=pvalueadj_SH2,beta_median=betaGYadj_median,se_median1=SDbetaGYadj_median1,se_median2=SDbetaGYadj_median2,p_median1=pvalueadj_median1,p_median2=pvalueadj_median2,beta_ivw=betaGYadj_ivw,se_ivw1=SDbetaGYadj_ivw1,se_ivw2=SDbetaGYadj_ivw2,p_ivw1=pvalueadj_ivw1,p_ivw2=pvalueadj_ivw2,beta_lasso=betaGYadj_lasso,se_lasso1=SDbetaGYadj_lasso1,se_lasso2=SDbetaGYadj_lasso2,p_lasso1=pvalueadj_lasso1,p_lasso2=pvalueadj_lasso2,beta_true=SNP_effect )
