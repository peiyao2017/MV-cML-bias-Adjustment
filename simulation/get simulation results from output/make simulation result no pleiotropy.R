...
for(d in c(1)){
  for(rho in c(0 )){
    if(10>0){
      N=20
      setwd(paste("D:/art sim/New/no_pleiotropy/","d=",d,sep=""))
      plotname=numeric()
      name1_1=numeric()
      plotname[1]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_before.jpeg",sep="")
      plotname[2]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_after.jpeg",sep="")
      plotname[3]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_egger.jpeg",sep="")
      plotname[4]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_dd.jpeg",sep="")
      plotname[5]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_sh.jpeg",sep="")
      plotname[6]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_ivw.jpeg",sep="")
      plotname[7]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_lasso.jpeg",sep="")
      plotname[8]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_median.jpeg",sep="")
      filename1=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,".txt",sep="")
      filename2=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"Slope.txt",sep="")
      filename3=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"point_effect_estimates.RData",sep="")
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          egger61=power_egger21[which.max(change1)]
        ...
        if(sum(change2>0)>0){
          egger62=power_egger22[which.max(change2)]
        ...
        if(sum(change1<0)>0){
          egger71=power_egger21[which.min(change1)]
        ...
        if(sum(change2<0)>0){
          egger72=power_egger22[which.min(change2)]
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          DD61=power_DD21[which.max(change1)]
          sdDD61=sd(all_snps_y[[which.max(change1)]]$p_DD1<0.05)
        }
        if(sum(change1>0)==0){
          DD61=NA
          sdDD61=NA
        ...
        if(sum(change2>0)>0){
          DD62=power_DD22[which.max(change2)]
          sdDD62=sd(all_snps_y[[which.max(change2)]]$p_DD2<0.05)
        }
        if(sum(change2>0)==0){
          DD62=NA
          sdDD62=NA
        ...
        if(sum(change1<0)>0){
          DD71=power_DD21[which.min(change1)]
          sdDD71=sd(all_snps_y[[which.min(change1)]]$p_DD1<0.05)
        }
        if(sum(change1<0)==0){
          DD71=NA
          sdDD71=NA
        ...
        if(sum(change2<0)>0){
          DD72=power_DD22[which.min(change2)]
          sdDD72=sd(all_snps_y[[which.min(change2)]]$p_DD2<0.05)
        }
        if(sum(change2<0)==0){
          DD72=NA
          sdDD72=NA
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          SH61=power_SH21[which.max(change1)]
          sdSH61=sd(all_snps_y[[which.max(change1)]]$p_SH1<0.05)
        }
        if(sum(change1>0)==0){
          SH61=NA
          sdSH61=NA
        ...
        if(sum(change2>0)>0){
          SH62=power_SH22[which.max(change2)]
          sdSH62=sd(all_snps_y[[which.max(change2)]]$p_SH2<0.05)
        }
        if(sum(change2>0)==0){
          SH62=NA
          sdSH62=NA
        ...
        if(sum(change1<0)>0){
          SH71=power_SH21[which.min(change1)]
          sdSH71=sd(all_snps_y[[which.min(change1)]]$p_SH1<0.05)
        }
        if(sum(change1<0)==0){
          SH71=NA
          sdSH71=NA
        ...
        if(sum(change2<0)>0){
          SH72=power_SH22[which.min(change2)]
          sdSH72=sd(all_snps_y[[which.min(change2)]]$p_SH2<0.05)
        }
        if(sum(change2<0)==0){
          SH72=NA
          sdSH72=NA
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          median61=power_median21[which.max(change1)]
        ...
        if(sum(change2>0)>0){
          median62=power_median22[which.max(change2)]
        ...
        if(sum(change1<0)>0){
          median71=power_median21[which.min(change1)]
        ...
        if(sum(change2<0)>0){
          median72=power_median22[which.min(change2)]
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          lasso61=power_lasso21[which.max(change1)]
        ...
        if(sum(change2>0)>0){
          lasso62=power_lasso22[which.max(change2)]
        ...
        if(sum(change1<0)>0){
          lasso71=power_lasso21[which.min(change1)]
        ...
        if(sum(change2<0)>0){
          lasso72=power_lasso22[which.min(change2)]
      ...
      if(10>0){
        ...
        if(sum(change1>0)>0){
          ivw61=power_ivw21[which.max(change1)]
        ...
        if(sum(change2>0)>0){
          ivw62=power_ivw22[which.max(change2)]
        ...
        if(sum(change1<0)>0){
          ivw71=power_ivw21[which.min(change1)]
        ...
        if(sum(change2<0)>0){
          ivw72=power_ivw22[which.min(change2)]
      ...
      if(10>0){
        ...
        DD1=round(c(DD11,DD21,DD31,DD41,DD51,DD61,DD71  ),3)
        sdDD1=round(c(sdDD11,sdDD21,sdDD31,sdDD41,sdDD51,sdDD61,sdDD71 ),3)
        DD2=round(c(DD12,DD22,DD32,DD42,DD52,DD62,DD72 ),3)
        sdDD2=round(c(sdDD12,sdDD22,sdDD32,sdDD42,sdDD52,sdDD62,sdDD72 ),3)
        
        SH1=round(c(SH11,SH21,SH31,SH41,SH51,SH61,SH71 ),3)
        sdSH1=round(c(sdSH11,sdSH21,sdSH31,sdSH41,sdSH51,sdSH61,sdSH71 ),3)
        SH2=round(c(SH12,SH22,SH32,SH42,SH52,SH62,SH72 ),3)
        sdSH2=round(c(sdSH12,sdSH22,sdSH32,sdSH42,sdSH52,sdSH62,sdSH72 ),3)
      ...
      if(10>0){
        ...
        legend("topleft",pch=c(15 ),col=c("black" ),legend=c("H only" ),cex=c(0.7 ))
        abline(a=0,b=1)
        for(i in 1:50){
...
for(d in c(2,4 )){
  for(rho in c(0 )){
    if(10>0){
      ...
      plotname[4]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_ivw.jpeg",sep="")
      plotname[5]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_lasso.jpeg",sep="")
      plotname[6]=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"_median.jpeg",sep="")
      filename1=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,".txt",sep="")
      filename2=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"Slope.txt",sep="")
      filename3=paste("D:/art sim/New/no_pleiotropy/result/","d=",d,"/","d=",d,"betaXYnot0rho",rho,"point_effect_estimates.RData",sep="")
      ...
      if(10>0){
        ...
        for(i in 1:length(all_snps)){
          colnames(all_snps[[i]])=c(colnames(all_snps[[i]])[1:(ncol(all_snps[[i]])-1*d)],name6se)
        }
      }
      null_snps=list()
      for(i in 1:900){
      ...
      if(10>0){
        ...
        slope_estimated=data.frame(b_cml=sapply(all_snps[[1]][b_cml_name],mean),b_cml_sd=sapply(all_snps[[1]][b_cml_name],sd),b_cml_se=sqrt(sapply(all_snps[[1]][se_b_cml_name],mean)),
                                   b_egger=sapply(all_snps[[1]][b_egger_name],mean),b_egger_sd=sapply(all_snps[[1]][b_egger_name],sd),b_egger_se=sqrt(sapply(all_snps[[1]][se_b_egger_name],mean)),
                                   b_ivw=sapply(all_snps[[1]][b_ivw_name],mean),b_ivw_sd=sapply(all_snps[[1]][b_ivw_name],sd),b_ivw_se=sqrt(sapply(all_snps[[1]][se_b_ivw_name],mean)),
                                   b_lasso=sapply(all_snps[[1]][b_lasso_name],mean),b_lasso_sd=sapply(all_snps[[1]][b_lasso_name],sd),b_lasso_se=sqrt(sapply(all_snps[[1]][se_b_lasso_name],mean)),
                                   b_median=sapply(all_snps[[1]][b_median_name],mean),b_median_sd=sapply(all_snps[[1]][b_median_name],sd),b_median_se=sqrt(sapply(all_snps[[1]][se_b_median_name],mean)), 
                                   b_true=sapply(all_snps[[1]][b_true_name],mean),b_true_sd=sapply(all_snps[[1]][b_true_name],sd),b_true_se=sqrt(sapply(all_snps[[1]][se_b_true_name],mean)))
        slope_estimated=round(slope_estimated,digits=3)
