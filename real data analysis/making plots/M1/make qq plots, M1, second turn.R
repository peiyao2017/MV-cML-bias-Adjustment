...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/BMI/qqplotBMIM1secondturn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/Height/qqplotHeightM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/HC/qqplotHCM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/WC/qqplotWCM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/WHR/qqplotWHRM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/SBP/qqplotSBPM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/DBP/qqplotDBPM1secondturn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
