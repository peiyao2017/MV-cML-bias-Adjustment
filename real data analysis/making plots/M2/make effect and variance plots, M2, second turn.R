...
if(Ncov>0){
  ...
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/BMI/M2/effect BMI_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/BMI/M2/variance BMI_M2 second turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/Height/M2/effect Height_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/Height/M2/variance Height_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/SBP/M2/effect SBP_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/SBP/M2/variance SBP_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/DBP/M2/effect DBP_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/DBP/M2/variance DBP_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/WHR/M2/effect WHR_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/WHR/M2/variance WHR_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/WC/M2/effect WC_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/WC/M2/variance WC_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/HC/M2/effect HC_M2 second turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/HC/M2/variance HC_M2 second turn",i,".jpeg",sep="")
  }
  filename_before=numeric()
  filename_after=numeric()
  for(i in 1:Ncov){
