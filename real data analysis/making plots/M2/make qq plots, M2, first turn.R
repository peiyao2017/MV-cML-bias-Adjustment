...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/BMI/M2/qqplotBMIM2firstturn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/WHR/M2/qqplotWHRM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/Height/M2/qqplotHeightM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/SBP/M2/qqplotSBPM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/DBP/M2/qqplotDBPM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/WC/M2/qqplotWCM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
...
if(Ncov>0){
  qqplot_name=numeric()
  for(i in 1:Ncov){
    qqplot_name[i]=paste("D:/HC/M2/qqplotHCM2firstturn",i,".jpeg",sep="")
  }
  filename_after=numeric()
  for(i in 1:Ncov){
    filename_after[i]=paste("resultMAInfo",i,".txt",sep="")
