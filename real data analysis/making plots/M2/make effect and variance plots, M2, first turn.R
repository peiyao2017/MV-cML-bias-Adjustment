...
if(Ncov>0){
  ...
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/BMI/M2/effect_M2 BMI first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/BMI/M2/variance_M2 BMI first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/SBP/M2/effect_M2 SBP first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/SBP/M2/variance_M2 SBP first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/DBP/M2/effect_M2 DBP first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/DBP/M2/variance_M2 DBP first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/Height/M2/effect_M2 Height first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/Height/M2/variance_M2 Height first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/WHR/M2/effect_M2 WHR first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/WHR/M2/variance_M2 WHR first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/WC/M2/effect_M2 WC first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/WC/M2/variance_M2 WC first turn",i,".jpeg",sep="")
  }
...
if(Ncov>0){
  ...
  variance_plot_name=numeric()
  for(i in 1:N_plots){
    effect_plot_name[i]=paste("D:/HC/M2/effect_M2 HC first turn",i,".jpeg",sep="")
    variance_plot_name[i]=paste("D:/HC/M2/variance_M2 HC first turn",i,".jpeg",sep="")
  }
  ...
  for(i in 1:N_plots){
    ...
    plot(atotal[,1],atotal[,2],main="HC Standard errors",xlab="before adjustment ",ylab="after adjustment ",type ="n",sub=subtitle[i],xlim=c(min(x1),max(x2)),ylim=c(min(y1),max(y2)))
    abline(a=0,b=1,lwd=1)
    points(a1[,1],a1[,2],pch=16,col="#666666")
    points(a2[,1],a2[,2],pch=17,col="#9933FF")
    points(a3[,1],a3[,2],pch=15,col="#CC9900")
