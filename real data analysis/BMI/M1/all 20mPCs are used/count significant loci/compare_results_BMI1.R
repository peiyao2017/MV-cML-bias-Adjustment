setwd("/panfs/jay/groups/20/panwei/wan01299/collider_bias/BMI/MV_Egger/new/new_gwas/BMIMET/BMIMETPC/M1/first_turn")
...
filename=c("resultDD1.txt","resultSH1.txt",
           "resultEgger1.txt","resultEgger2.txt","resultEgger3.txt","resultEgger4.txt","resultEgger5.txt",
           "resultLasso1.txt","resultLasso2.txt","resultLasso3.txt","resultLasso4.txt","resultLasso5.txt",
           "resultMedian1.txt","resultMedian2.txt","resultMedian3.txt","resultMedian4.txt","resultMedian5.txt",
           "resultMVMRcML1.txt","resultMVMRcML2.txt","resultMVMRcML3.txt","resultMVMRcML4.txt","resultMVMRcML5.txt",
           "resultMVMRIVW1.txt","resultMVMRIVW2.txt","resultMVMRIVW3.txt","resultMVMRIVW4.txt","resultMVMRIVW5.txt")
Nmethod=length(filename)
print("here1")
outputname=numeric()
 
for(i in 1:Nmethod){
  outputname[i]=paste('Res_ldblockBMI_',filename[i],'BMI_M1_first_turn.RData',sep="")
}
result1=read.table(file="response_20.BMI.glm.linear",header = FALSE)
