setwd("/panfs/jay/groups/20/panwei/wan01299/collider_bias/BMI/MV_Egger/new/new_gwas/BMIMET/BMIMETPC/uvmr_mvmr/")
...
filename=c("resultDD2.txt","resultSH2.txt","resultUVMREgger2.txt","resultUVMRLasso2.txt","resultUVMRMedian2.txt","resultUVMRcML2.txt","resultUVMRIVW2.txt")
