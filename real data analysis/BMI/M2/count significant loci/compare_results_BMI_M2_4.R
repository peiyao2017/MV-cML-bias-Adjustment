...
filename=c("resultEgger4.txt","resultLasso4.txt","resultMedian4.txt","resultMVMRcML4.txt","resultMVMRIVW4.txt")
...
result1=read.table(file="responseM2_4.BMI.glm.linear",header = FALSE)
