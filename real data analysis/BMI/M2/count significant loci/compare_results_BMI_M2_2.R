...
filename=c("resultEgger2.txt","resultLasso2.txt","resultMedian2.txt","resultMVMRcML2.txt","resultMVMRIVW2.txt")
...
result1=read.table(file="responseM2_2.BMI.glm.linear",header = FALSE)
