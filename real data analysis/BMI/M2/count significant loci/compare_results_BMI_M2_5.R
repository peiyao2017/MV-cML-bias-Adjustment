...
filename=c("resultEgger5.txt","resultLasso5.txt","resultMedian5.txt","resultMVMRcML5.txt","resultMVMRIVW5.txt")
...
result1=read.table(file="responseM2_5.BMI.glm.linear",header = FALSE)
