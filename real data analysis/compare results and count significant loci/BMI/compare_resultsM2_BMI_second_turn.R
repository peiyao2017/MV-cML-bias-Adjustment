setwd("/panfs/jay/groups/20/panwei/wan01299/collider_bias/BMI")
...
for(i in 1:Ncov){
  ...
  filename_before[i]=paste("/panfs/jay/groups/20/panwei/wan01299/collider_bias/M2/BMI/coefficient/responseM2_",i,".BMI.glm.linear",sep="")
}
outputname=numeric()
for(i in 1:Ncov){
