...
for(i in 1:Ncov){
  ...
  filename_before[i]=paste("/panfs/jay/groups/20/panwei/wan01299/collider_bias/M2/WHR/coefficient/responseM2_",i,".WHR.glm.linear",sep="")
}
outputname=numeric()
for(i in 1:Ncov){
...
for(u in 1:Ncov){
  ...
  if(nrow(sig_after)>0){
    ...
    Res = list(a1=a1,a2=a2,a3=a3,Nsnps_before=Nsnps_before,
               before=before,
  ...
  if(nrow(sig_after)==0){
    ...
    before=length(a1)
    validation_small_before=NA
    validation_large_before=sum(a1 %in% a2)
    ...
    Res = list(a1=a1,a2=a2,Nsnps_before=Nsnps_before,
               before=before,
               validation_small_before=validation_small_before,
               validation_large_before=validation_large_before,
               Nsnps_after=Nsnps_after,
