...
gene2=read.table(file='/panfs/jay/groups/20/panwei/wan01299/collider_bias/M2/HC/110K_QCed1.fam',header = FALSE)
...
for(i in 1:Ncov){
  response_gwas_name[i]=paste("response_",i,".HC.glm.linear",sep="")
}
for(i in 1:Ncov){
...
nameX=numeric()
for(i in 1:Ncov){
  nameX[i]=paste("/panfs/jay/groups/20/panwei/wan01299/collider_bias/M2/HC/MET.PC",i,".glm.linear",sep="")
}
